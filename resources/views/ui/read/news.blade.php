...
@section('content')
    <nav class="w-full p-4 border-b border-gray-300 flex items-center bg-white justify-between">
        <div class="flex items-center gap-3">
            ...
            <p class="line-clamp-1 w-[80%]">Berita</p>
        </div>
        <a href="">
    ...
    <section class="p-4 border-b border-gray-300 bg-white">
        ...
        <div class="header-chapter text-slate-900">
            <p class="text-xl font-semibold">Dicari programmer PHP Laravel berpengalaman dalam
                pengembangan saas</p>
        </div>
        ...
        <div class="flex justify-end">
            <a class="text-blue-500 flex items-center gap-4" href="">
                <svg class="m-auto rotate-180 my-4 opacity-100" stroke="currentColor" fill="currentColor" stroke-width="0"
